  ...
  try {
    ...
    if (found) {
      ...
      const mailOptions = {
        from: email,
        to: req.body.Email,
        subject: 'Account created succeffuly',
        html: `
        <p>Hello , <br/> You have created an account , You are allowed to connect with your chosen email and password <br/> GoodBye and thak you for your confidence </p>
      `,
      };
